...
function boot () {
    var onStart = function () {
        ...
        //minigame初始化
        window.minigame.initializeAsync().then(function () {
            // success
            console.log("minigame初始化成功");
            ...
            cc.director.loadScene(launchScene, null,
                function () {
                    ...
                    //进入游戏
                    window.minigame.startGameAsync().then(function () {
                        // success
                        console.log("进入游戏成功");
                        })
                        .catch(function(e){
                        // failed
                        console.log("进入游戏失败，原因: ", e);
                        });
